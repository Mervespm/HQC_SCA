...
|---|---|---|---|
| single_query_oracle_acc_baseline | 0.7440 | fraction | device CW310 HQC-G, m'=0 vs decode-failure, fillers anywhere |
| peak_tvla_t_baseline | 14.216 | abs_t | Welch |t|, baseline ciphertext |
| single_query_oracle_acc_fix7 | 0.7600 | fraction | device CW310 HQC-G, fix #7 systematic-region fillers |
| peak_tvla_t_fix7 | 17.068 | abs_t | Welch |t|, fix #7 ciphertext (stronger leak) |
| boundary_word_success_rate | 0.6000 | fraction | make_boundary_word() probeable-pivot rate (40% unprobeable) |
| model_oracle_acc_baseline_RS_T_any | 0.7250 | fraction | HW-model acc; d'=0.9455, class0 HW 8.150, class1 HW 18.733 |
| model_oracle_acc_RS_T_sys | 0.7583 | fraction | HW-model acc; d'=1.2393, class0 HW 18.683, class1 HW 52.117 |
